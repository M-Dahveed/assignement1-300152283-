...
public class PointCP2Test {
    public static void main(String[] args) {
        PointCP2 point1 = new PointCP2('P', 5, 45);
        long start1 = System.currentTimeMillis();
        for (int i = 0; i < 99999999; i++) {
            point1.getRho();
        }
        long end1 = System.currentTimeMillis();
        System.out.println("Time elapsed for getRho(CP2): " + (end1 - start1) * 0.001);
        ...
        System.out.println("Time elapsed for getTheta(CP2): " + (end2 - start2) * 0.001);
        ...
        System.out.println("Time elapsed for getX(CP2): " + (end3 - start3) * 0.001);
        ...
        System.out.println("Time elapsed for getY(CP2): " + (end4 - start4) * 0.001);
        ...
        System.out.println("Time elapsed for getDistance(CP2): " + (end5 - start5) * 0.001);
    }
